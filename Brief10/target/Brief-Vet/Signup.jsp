    ...
    <div style="background-color: #FAD8B1; min-height: 400px;"></div>
        <div class="container" style="padding: 10%;margin-top: -400px;">
            <div class="row">
                <div class="col-lg">
                    <h2>Sign Up!</h2>
                    <img src="./img/zfeaea.png" alt="cat" style="margin-left: -80px; width: 110%;">
                </div>
                <div class="col-lg" style="background-color: #E5E5E5; padding: 5%; border-radius: 2em;">
                    ...
                    <div class="mb-3">
                        ...
                        <button class="btn " type="submit"
                            style="margin-left: 140px; background-color: #EB5E30; border-radius: 1em; color: white; box-shadow: 2px 2px #888888;">Signup</button>
                    </div>
                </div>
            </div>
        </div>
