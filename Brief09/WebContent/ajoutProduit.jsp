...
<!DOCTYPE html>
	<html>
    	...
    	<div class="col-lg two" style="padding: 50px; ">
			...
			<div class="card-header" style="background-color: #01476A; color: #FFFFFF; border-radius: 0px"> Ajouter des Articles</div>
			<div class="card-body">
			<form action="SaveArticle.do" method="post" enctype="multipart/form-data">
			...
			<div>
				<button type="submit" style="background-color: #01476A; border-radius: 0px; margin-left: 200px" class="btn btn-warning">Ajouter</button>
			</div>
			</form>
		</div>
	</div>
